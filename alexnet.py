...
tf.app.flags.DEFINE_integer('charset_size', 4135, "Choose the first `charset_size` character to conduct our experiment.")
...
tf.app.flags.DEFINE_integer('eval_steps', 32, "the step num to eval")
tf.app.flags.DEFINE_integer('save_steps', 32, "the steps to save")
tf.app.flags.DEFINE_integer('decay_step', 32*2, 'Number of decay-step')
tf.app.flags.DEFINE_integer('val_step', 32, 'Number of decay-step')

tf.app.flags.DEFINE_string('checkpoint_dir', './checkpoint4135_enhance_count5/', 'the checkpoint dir')
tf.app.flags.DEFINE_string('train_data_dir', 'H:/why_workspace/ReCTS/img_dir4/', 'the train dataset dir')
tf.app.flags.DEFINE_string('val_data_dir', 'H:/why_workspace/ReCTS/img_dir4/', 'the train dataset dir')
...
tf.app.flags.DEFINE_string('mode', 'validation_output_txt', 'Running mode. One of {"train", "validation", "test"}')
